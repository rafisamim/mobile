...
export default class ResourcesScreen extends React.Component {
  ...
  getData = async() => {
    let url = Setting.resourcesApi + this.props.screenProps.i18n.language + '/' + this.state.offset + '?search=' + this.state.searchQuery + '&' + this.props.navigation.getParam('type') + '=' + this.props.navigation.getParam('catId');
    ...
    let _renderItem = ({ item }) => (
      <View 
        ...
        <TouchableOpacity onPress={ () => {
          ...
          <Text 
            style={{ marginTop:5, textAlign: 'center', writingDirection: (this.props.screenProps.i18n.language != 'en') ? 'rtl' : 'ltr' }}>
